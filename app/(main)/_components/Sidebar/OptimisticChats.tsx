    ...
    <>
      {optimisticChats.map((chat) => (
        <div key={chat.id} className="group relative mx-2">
          <span className="block w-full min-w-0 items-center justify-between truncate rounded-lg bg-gray-300 py-2 pr-6 pl-3 text-sm text-gray-900 group-has-data-popup-open:bg-gray-200">
            {chat.title}
          </span>
